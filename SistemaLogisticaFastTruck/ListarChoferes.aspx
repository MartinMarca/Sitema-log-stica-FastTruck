<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListarChoferes.aspx.vb" Inherits="SistemaLogisticaFastTruck.ListarChoferes" %>
...
<body>
        ...
        <nav class="navbar bg-dark navbar-dark navbar-expand-lg container fuenteNavBar fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav text-center mr-auto ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="ListarChoferes.aspx">Choferes</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container display-1"> Choferes
        <img style="width:250px" src="imagenes/iconoChofer.jpg"/>
    </div>
    <br /><br />
    <div class="container">
        <form id="Form_ListarChoferes" runat="server">
            <div>
                <asp:Repeater ID="Rpt_Chofer" runat="server">
                    <HeaderTemplate>
                        <table>
                            <tr>
                                <th>Nombre</th>
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            <td><%#Container.DataItem("nombreChofer")%></td>
                            <td><%#Container.DataItem("apellidoChofer")%></td>
                            <td><%#Container.DataItem("dni")%></td>
                            <td><%#Container.DataItem("disponible")%></td>
                                                        
                            <td><a class="btn btn-dark" role="button" href="Baja_ModificacionChofer.aspx?idparametro=<%#Container.DataItem("idChofer")%>">modificar</a>
                                <a class="btn btn-dark" role="button" href="Baja_ModificacionChofer.aspx?idparametro=<%#Container.DataItem("idChofer")%>">eliminar</a></td>
        ...
        <div><a class="btn btn-dark btn-lg btn-block" role="button" href="AltaChofer.aspx">Agregar un nuevo chofer</a></div>
