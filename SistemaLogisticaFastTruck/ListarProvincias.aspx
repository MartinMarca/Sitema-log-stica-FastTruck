<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListarProvincias.aspx.vb" Inherits="SistemaLogisticaFastTruck.ListarProvincias" %>
...
<body>
        ...
        <nav class="navbar bg-dark navbar-dark navbar-expand-lg container fuenteNavBar fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav text-center mr-auto ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" href="ListarProvincias.aspx">Provincias</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container display-3"> Provincias a las que viajamos
        <img />
    </div>

    <div class="container">
        <form id="Form_ListarProvincias" runat="server">
            <div>
                <asp:Repeater ID="Rpt_Provincia" runat="server">
                    <HeaderTemplate>
                        <table>
                            <tr>
                                <th>Prvincia</th>                                
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-dark" role="button" href="Baja_ModificacionProvincia.aspx?idparametro=<%#Container.DataItem("idProvincia")%>">modificar</a>
                                <a class="btn btn-dark" role="button" href="Baja_ModificacionProvincia.aspx?idparametro=<%#Container.DataItem("idProvincia")%>">eliminar</a></td>
        ...
        <div><a class="btn btn-dark btn-lg btn-block" role="button" href="AltaProvincia.aspx">Agregar una nueva provincia</a></div>
